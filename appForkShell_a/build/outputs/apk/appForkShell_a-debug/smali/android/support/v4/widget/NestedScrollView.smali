...
.implements Landroid/support/v4/g/at;
...
.field private final x:Landroid/support/v4/g/au;

.field private final y:Landroid/support/v4/g/as;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/g/au;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/g/au;

    new-instance v0, Landroid/support/v4/g/as;

    invoke-direct {v0, p0}, Landroid/support/v4/g/as;-><init>(Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/g/as;
    ...
    invoke-static {p0, v0}, Landroid/support/v4/g/bb;->a(Landroid/view/View;Landroid/support/v4/g/a;)V
...
.method private a(Landroid/view/MotionEvent;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/g/ai;->b(Landroid/view/MotionEvent;I)I
    ...
    :goto_0
    invoke-static {p1, v0}, Landroid/support/v4/g/ai;->d(Landroid/view/MotionEvent;I)F
...
.method private g()V
    ...
    invoke-static {p0}, Landroid/support/v4/g/bb;->a(Landroid/view/View;)I
...
.method public final a(II)V
    ...
    invoke-static {p0}, Landroid/support/v4/g/bb;->b(Landroid/view/View;)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/g/as;

    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/g/as;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/g/as;->a(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/g/as;->a(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/g/as;->a(IIII[I)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Landroid/support/v4/g/au;

    invoke-virtual {v0}, Landroid/support/v4/g/au;->a()I
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/g/as;->b()Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/g/as;->a()Z
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/g/ai;->c(Landroid/view/MotionEvent;)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/g/ai;->e(Landroid/view/MotionEvent;I)F
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p1, v1}, Landroid/support/v4/g/ai;->a(Landroid/view/MotionEvent;I)I
    ...
    :cond_2
    invoke-static {p1, v2}, Landroid/support/v4/g/ai;->d(Landroid/view/MotionEvent;I)F
    ...
    invoke-static {p1, v3}, Landroid/support/v4/g/ai;->b(Landroid/view/MotionEvent;I)I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/g/au;->a(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/g/au;->a(Landroid/view/View;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/g/ai;->a(Landroid/view/MotionEvent;)I
    ...
    invoke-static {v0, v2}, Landroid/support/v4/g/ai;->b(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v2}, Landroid/support/v4/g/ai;->a(Landroid/view/MotionEvent;I)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/g/ai;->d(Landroid/view/MotionEvent;I)F
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/g/bb;->a(Landroid/view/View;)I
    ...
    invoke-static {v0, v1}, Landroid/support/v4/g/ai;->c(Landroid/view/MotionEvent;I)F
    ...
    :cond_10
    invoke-static/range {p0 .. p0}, Landroid/support/v4/g/bb;->b(Landroid/view/View;)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/g/aw;->a(Landroid/view/VelocityTracker;I)F
    ...
    :pswitch_5
    invoke-static/range {p1 .. p1}, Landroid/support/v4/g/ai;->b(Landroid/view/MotionEvent;)I

    move-result v2

    move-object/from16 v0, p1

    invoke-static {v0, v2}, Landroid/support/v4/g/ai;->d(Landroid/view/MotionEvent;I)F
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/g/as;->a(Z)V
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/g/as;->a(I)Z
