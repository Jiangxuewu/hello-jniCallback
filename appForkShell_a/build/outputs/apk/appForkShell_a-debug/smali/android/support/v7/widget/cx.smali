...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/cx;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/cu;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/support/v7/widget/cx;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/g;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/cx;->a:Landroid/support/v7/view/menu/g;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/cx;->b:Landroid/support/v7/view/menu/j;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/cx;->a:Landroid/support/v7/view/menu/g;

    iget-object v1, p0, Landroid/support/v7/widget/cx;->b:Landroid/support/v7/view/menu/j;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/g;->d(Landroid/support/v7/view/menu/j;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/cx;->a:Landroid/support/v7/view/menu/g;
...
.method public a(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/cx;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/cx;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/cx;->b:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/Toolbar;->d()Landroid/support/v7/widget/cy;

    move-result-object v0

    const v1, 0x800003

    iget-object v2, p0, Landroid/support/v7/widget/cx;->c:Landroid/support/v7/widget/Toolbar;
...
.method public b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/cx;->a:Landroid/support/v7/view/menu/g;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/cx;->a:Landroid/support/v7/view/menu/g;

    invoke-virtual {v3, v1}, Landroid/support/v7/view/menu/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/cx;->b:Landroid/support/v7/view/menu/j;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/cx;->b(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
...
.method public b(Landroid/support/v7/view/menu/g;Landroid/support/v7/view/menu/j;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/cx;->b:Landroid/support/v7/view/menu/j;
