...
# static fields
.field static final a:Landroid/support/v7/widget/cg;
...
.field private q:Landroid/support/v7/widget/ci;

.field private r:Landroid/support/v7/widget/ch;

.field private s:Landroid/view/View$OnFocusChangeListener;

.field private t:Landroid/support/v7/widget/cj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/cg;
...
.method private l()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/cm;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cm;->a(I)V
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/ci;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/ci;->a(Ljava/lang/String;)Z
...
.method private o()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ch;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ch;

    invoke-interface {v0}, Landroid/support/v7/widget/ch;->a()Z
...
.method private q()V
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/cg;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cg;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/cg;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cg;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/bi;->clearFocus()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/bi;->onDetachedFromWindow()V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/bi;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    :goto_0
    return-void

    :cond_0
    check-cast p1, Landroid/support/v7/widget/ck;

    invoke-virtual {p1}, Landroid/support/v7/widget/ck;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroid/support/v7/widget/bi;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iget-boolean v0, p1, Landroid/support/v7/widget/ck;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Landroid/support/v7/widget/bi;->onSaveInstanceState()Landroid/os/Parcelable;

    move-result-object v0

    new-instance v1, Landroid/support/v7/widget/ck;

    invoke-direct {v1, v0}, Landroid/support/v7/widget/ck;-><init>(Landroid/os/Parcelable;)V

    invoke-virtual {p0}, Landroid/support/v7/widget/SearchView;->c()Z

    move-result v0

    iput-boolean v0, v1, Landroid/support/v7/widget/ck;->a:Z
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/bi;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/bi;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/ch;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ch;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/ci;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/ci;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/cj;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/cj;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/cm;
