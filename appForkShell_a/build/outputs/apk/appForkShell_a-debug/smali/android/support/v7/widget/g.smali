...
.method public run()V
    ...
    invoke-static {v1}, Landroid/support/v4/g/bb;->h(Landroid/view/View;)Landroid/support/v4/g/cl;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/g/cl;->a(F)Landroid/support/v4/g/cl;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v7/widget/g;->a:Landroid/support/v7/widget/ActionBarOverlayLayout;

    invoke-static {v2}, Landroid/support/v7/widget/ActionBarOverlayLayout;->b(Landroid/support/v7/widget/ActionBarOverlayLayout;)Landroid/support/v4/g/da;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/g/cl;->a(Landroid/support/v4/g/da;)Landroid/support/v4/g/cl;

    move-result-object v1

    invoke-static {v0, v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->a(Landroid/support/v7/widget/ActionBarOverlayLayout;Landroid/support/v4/g/cl;)Landroid/support/v4/g/cl;
