...
.method public constructor <init>(Landroid/support/v7/widget/at;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p4}, Landroid/support/v7/widget/bk;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/aw;->e:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/aw;)Landroid/widget/ListAdapter;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aw;->d:Landroid/widget/ListAdapter;
...
.method static synthetic b(Landroid/support/v7/widget/aw;)V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/bk;->c()V
...
.method private b(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/g/bb;->o(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/aw;->e:Landroid/graphics/Rect;
...
.method public a()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/aw;->c:Ljava/lang/CharSequence;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/bk;->a(Landroid/widget/ListAdapter;)V

    iput-object p1, p0, Landroid/support/v7/widget/aw;->d:Landroid/widget/ListAdapter;
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/aw;->c:Ljava/lang/CharSequence;
...
.method b()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aw;->d()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/df;->a(Landroid/view/View;)Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aw;->h()I
    ...
    :goto_4
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/aw;->b(I)V
...
.method public c()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/aw;->k()Z
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/aw;->g(I)V

    invoke-super {p0}, Landroid/support/v7/widget/bk;->c()V

    invoke-virtual {p0}, Landroid/support/v7/widget/aw;->m()Landroid/widget/ListView;
